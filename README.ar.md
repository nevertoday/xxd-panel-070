...
# 🦁 XXD Panel 070｜جزيرة مريحة بطلاء سميك

### يختزل الصور في تكوينات يدوية مشرقة وخفيفة ذات حسّ نشر تحريري
...
تنتهي كثير من معالجات الصور إما برسم المشهد كاملاً حتى يزدحم، أو بتطبيق أسلوب كرتوني عام يفقد الموضوع هويته وروح ألوان الصورة.

يحتفظ **Panel 070** فقط بالموضوع والوضعية والعلاقة والاستعارة الأكثر رسوخاً في الصورة، ثم يعيد تنظيمها بخطوط يدوية وطلاء كثيف مشرق أو مساحات لونية شبه شفافة. يوضع الموضوع بحجم مصغّر أو متوسط داخل فراغ واسع أبيض دافئ، وترافقه شبكات ورذاذ وهالات وعلامات هندسية قليلة. أما الكتابة الدقيقة الشبيهة بالآلة الكاتبة فتشارك الصورة في بناء التكوين بدلاً من أن تُضاف فوقها.
...
- تخطيطات تجمع الحجم المصغّر والفراغ المضيء والاتجاه والنص القليل في إيقاع واحد؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 070 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** خطوط يدوية · طلاء مشرق／لون شبه شفاف · موضوع مصغّر · فراغ أبيض دافئ · خط تحريري شبيه بالآلة الكاتبة
...
|---|---|
| **الناتج** | صورة يدوية مشرقة ومريحة وخفيفة ذات نظام نشر واضح |
| **البصمة الواضحة** | موضوع مصغّر داخل فراغ أبيض دافئ، وخطوط يدوية مع طلاء حي أو لون شبه شفاف، ونص صغير مقتصد يشبه الآلة الكاتبة |
...
```text
تثبيت الهوية والوضعية والعلاقة → حذف المشهد الكامل والخلفية الثانوية → ضبط الموضوع على مقياس تحريري → إعادة بنائه بخطوط يدوية وطلاء مشرق／لون شبه شفاف → إعادة مزج أكثر ألوان المصدر حيوية → إضافة شبكات أو رذاذ أو ضوء بقدر قليل → ترتيب نص مقتصد داخل الفراغ الأبيض الدافئ
```

## سمات النتيجة النهائية

- يحتفظ التصميم بالهوية والوضعية والهيئة والعلاقة السردية الأكثر رسوخاً بدلاً من إعادة رسم المشهد كاملاً.
- تبقى الخطوط واضحة ويدوية، وتمزج المساحات اللونية الغواش والمائي والباستيل وقدراً قليلاً من ملمس الزيت.
- يوضع الموضوع بحجم مصغّر أو متوسط داخل فراغ أبيض دافئ، وتبني التراتبية والاتجاه وعلاقة الصورة بالنص الصفحة.
- تظل الشبكات والرذاذ والهالات والنقاط اللونية والعلامات الهندسية وسائل تحريرية قليلة فقط.
- تُعاد معايرة الألوان من أكثر أجزاء المصدر سطوعاً وحيوية، من دون فرض لوحة خارجية.
- تُولَّد كتابة رفيعة شبيهة بالآلة الكاتبة، بانحراف طباعة طفيف، من موضوع الصورة أو مكانها أو شعورها أو استعارتها.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-070-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 070. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-070 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-070 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-070 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-070 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-070 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 070 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-070 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-070`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-070-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-070-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ70 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 070 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–070) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
